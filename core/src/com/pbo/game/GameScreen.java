...
public class GameScreen implements Screen {
    ...
    public GameScreen(Armageddon game) {
        ...
        // frame hijau (bar HP)
        battery = new Battery(new Texture(Gdx.files.internal("backBattery.png")), new Texture(Gdx.files.internal("frontBattery.png")));
        ...
        // array jenis weapon
        weapons = new Array<>();
        weapons.add(new Weapon(new Texture(Gdx.files.internal("weapon1.png")), 500000000L));
        weapons.add(new Weapon(new Texture(Gdx.files.internal("weapon2.png")), 1000000000L));
        weapons.add(new Weapon(new Texture(Gdx.files.internal("weapon3.png")), 2000000000L));
    ...
    public void render(float delta) {
        ...
        // earth
        game.batch.draw(earth.getEarthImg(), earth.getX(), earth.getY(), earth.getDiameter(), earth.getDiameter());        // weapon (pakai sprite)

        // battery (bar HP)
        game.batch.draw(battery.getBack(), battery.getBackX(), battery.getBackY());
        game.batch.draw(battery.getFront(), battery.getFrontX(), battery.getFrontY());
        ...
        for (Iterator<Asteroid> iter = asteroids.iterator(); iter.hasNext(); ) {
            ...
            if (asteroid.y <= 90) {
                ...
                battery.setFrontX(battery.getFrontX() + 3 / 2 + asteroid.getDamage() * (350 / earth.getMaxHp()));
                if (earth.getHp() <= 0) {
                    gameOver.play();
                    earth.setHp(0);
    ...
    private void spawnAsteroid() {
        ...
        if (MathUtils.random(0, 1) == 0) {
            ...
            asteroid.setImg(arrayImg.get(MathUtils.random(0, 7)));
            asteroid.setDropSpeed(240 * Gdx.graphics.getDeltaTime());
            asteroid.setHp(2);
    ...
    private void shoot(int currentWeapNum) {
        ...
        switch (currentWeapNum) {
            case 0:
                ...
                break;
            case 1:
                Bullet pierceBullet = new Bullet(true);
